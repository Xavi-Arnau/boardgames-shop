  ...
  return (
    <div className="w-full md:w-1/6 p-4">
      <div className="border-2 rounded-lg flex flex-col items-center group h-[380px] p-4 hover:scale-110 shadow-lg">
        <img
          src="/newandfeatured/vida-salvaje-serengeti.jpg"
          alt=""
          className="object-fil w-40"
        />
        <div className="font-bold text-sm mt-4 h-16">
          Vida Salvaje: Serengeti
        </div>
